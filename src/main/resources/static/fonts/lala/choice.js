...
function initializeChoices() {
  ...
  document.querySelectorAll('[data-choices]').forEach(function (element) {
    ...
    const instance = new Choices(element, {
      ...
      shouldSort: false,
      placeholder: !!placeholder, // Habilitar placeholder solo si el atributo existe
      placeholderValue: placeholder, // Usar directamente el valor del atributo
    ...
    // Unificar comportamiento del input de búsqueda si aplica
    if (hasSearch) {
