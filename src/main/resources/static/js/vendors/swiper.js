function initializeSwiperCarousels() {
  document.querySelectorAll(".swiper-container").forEach((e) => {
    ...
    "fade" === u && (l.fadeEffect = { crossFade: !0 }),
      o && ((l.slidesPerView = "auto"), (l.centeredSlides = !0)),
      i &&
        (t = e.querySelector(".swiper-pagination")) &&
        ((l.pagination = { el: t, type: p, dynamicBullets: !0, clickable: !0 }),
        "custom" === p) &&
        (l.pagination.renderCustom = function (e, t, a) {
          var i = "";
          for (let e = 1; e <= a; e++)
            t == e
              ? (i += `<span class="swiper-pagination-numbers swiper-pagination-numbers-active">${e}</span>`)
              : (i += `<span class="swiper-pagination-numbers">${e}</span>`);
          return i;
        }),
      r
        ? (l.navigation = {
        ...
        : (a = e.querySelector(".swiper-navigation")) &&
          a.classList.add("swiper-navigation-hidden"),
      n && (l.autoplay = { delay: parseInt(s) }),
      new Swiper(e, l);
  });
}
